            ...
            <Form>
                <Stack direction="horizontal" className="justify-content-center">
                    <Form.Group controlId="busqueda" className="w-75 m-3">
                        <Form.Control type="text" placeholder="Buscar Profesor..." />
                    </Form.Group>
            ...
            <div className="container" style={{ marginTop: 20 }}>
                <div className="card p-5 mb-4 bg-body-tertiary rounded-3 shadow-sm border-primary" style={{ overflowX: 'auto' }}>
                    <header className="pb-3 mb-4 border-bottom border-3 border-dark text-dark">
                        <span className="fs-4"><i className="bi bi-person-video3"></i> Profesores activos</span>
                    </header>
                    ...
                    <div>
                        <Button><i className="bi bi-person-plus"></i> Registrar un nuevo profesor</Button>
                    </div>
                </div>
            </div>
        </Container>
